...
(defn main [& args]
  (jay/init-window screen-width screen-height "raylib [models] example - orthographic projection")
  ...
  (while (not (jay/window-should-close))
    ...
    (jay/draw-text "Press SPACE to change projection" 10 10 20 :dark-gray)
    (jay/draw-fps 10 30)
